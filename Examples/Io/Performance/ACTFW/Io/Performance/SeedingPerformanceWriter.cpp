...
FW::SeedingPerformanceWriter::SeedingPerformanceWriter(
    FW::SeedingPerformanceWriter::Config cfg, Acts::Logging::Level lvl)
...
FW::ProcessCode FW::SeedingPerformanceWriter::endRun() {
  if (m_outputFile) {
    m_outputFile->cd();
...
FW::ProcessCode FW::SeedingPerformanceWriter::writeT(
    const AlgorithmContext& ctx, const SeedContainer& seeds) {
